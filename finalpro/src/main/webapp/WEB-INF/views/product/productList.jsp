...
<script>
   ...
   function fn_priceSearch(form) {
      ...
      if(priceMin != "" && priceMax != "" && priceMax!=0 && priceMin > priceMax){
    	  alert('최대 가격이 최소가격보다 작습니다. 최대 가격이 최소 가격보다 크게 설정해주세요');
      }
   ...
   function fn_measure(form) {
      ...
      if (idName == 'topMinMax') {
         ...
         if(topMin != "" && topMax != "" && topMax!=0 && topMin > topMax){
          	  alert('최대 총장이 최소 총장보다 작습니다. 최대 총장이 최소 총장보다 크게 설정해주세요');
         }
         else if (topMin != "" && topMax != "" && topMax!=0) {
         ...
         if(shoulderMin != "" && shoulderMax != "" && shoulderMax!=0 && shoulderMin > shoulderMax){
         	  alert('최대 어깨너비가 최소 어깨너비보다 작습니다. 최대 어깨너비가 최소 어깨너비보다 크게 설정해주세요');
         }
         else if (shoulderMin != "" && shoulderMax != "" && shoulderMax!=0) {
         ...
         if(chestMin != "" && chestMax != ""&& chestMax!=0 && shoulderMin > shoulderMax){
        	  alert('최대 어깨너비가 최소 어깨너비보다 작습니다. 최대 어깨너비가 최소 어깨너비보다 크게 설정해주세요');
          }
         else if (chestMin != "" && chestMax != ""&& chestMax!=0) {
         ...
         if(sleeveMin != "" && sleeveMax != "" && sleeveMax!=0 && sleeveMin > sleeveMax){
       	  alert('최대 소매길이가 최소 소매길이보다 작습니다. 최대 소매길이가 최소 소매길이보다 크게 설정해주세요');
         }
         else if (sleeveMin != "" && sleeveMax != "" && sleeveMax!=0) {
         ...
         if(waistMin != "" && waistMax != "" && waistMax!=0  && waistMin > waistMax){
          	  alert('최대 허리단면이 최소 허리단면보다 작습니다. 최대 허리단면이 최소 허리단면보다 크게 설정해주세요');
         }
         else if (waistMin != "" && waistMax != "" && waistMax!=0 ) {
         ...
         if(hipMin != "" && hipMax != "" && hipMax!=0 && hipMin > hipMax){
         	  alert('최대 엉덩이단면이 최소 엉덩이단면보다 작습니다. 최대 엉덩이단면이 최소 엉덩이단면보다 크게 설정해주세요');
           }
         else if (hipMin != "" && hipMax != "" && hipMax!=0) {
         ...
         if(thighMin != "" && thighMax != "" && thighMax!=0 && thighMin > thighMax){
        	  alert('최대 허벅지단면이 최소 허벅지단면보다 작습니다. 최대 허벅지단면이 최소 허벅지단면보다 크게 설정해주세요');
          }
         else if (thighMin != "" && thighMax != "" && thighMax!=0) {
         ...
         if(riseMin != "" && riseMax != "" && riseMax !=0 && riseMin > riseMax){
       	  alert('최대 밑위가 최소 밑위보다 작습니다. 최대 밑위가 최소 밑위보다 크게 설정해주세요');
         }
         else if (riseMin != "" && riseMax != "" && riseMax !=0) {
         ...
         if(hemCrossMin != "" && hemCrossMax != "" && hemCrossMax !=0 && hemCrossMin > hemCrossMax){
          	  alert('최대 밑단이 최소 밑단보다 작습니다. 최대 밑단이 최소 밑단보다 크게 설정해주세요');
         }
         else if (hemCrossMin != "" && hemCrossMax != "" && hemCrossMax !=0) {
         ...
         if(footMin != "" && footMax != "" && footMax !=0 && footMin > footMax){
         	  alert('최대 발길이가 최소 발길이보다 작습니다. 최대 발길이가 최소 발길이보다 크게 설정해주세요');
         }
         else if (footMin != "" && footMax != "" && footMax !=0) {
         ...
         if(ballMin != "" && ballMax != "" && ballMax != 0 && ballMin > ballMax){
        	  alert('최대 발볼이 최소 발볼보다 작습니다. 최대 발볼이 최소 발볼보다 크게 설정해주세요');
          }
         else if (ballMin != "" && ballMax != "" && ballMax != 0) {
         ...
         if(ankleMin != "" && ankleMax != "" && ankleMax !=0 && ankleMin > ankleMax){
       	  alert('최대 발목이 최소 발목보다 작습니다. 최대 발목이 최소 발목보다 크게 설정해주세요');
         }
         else if (ankleMin != "" && ankleMax != "" && ankleMax !=0) {
         ...
         if(instepMin > instepMax){
          	  alert('최대 굽높이가 최소 굽높이보다 작습니다. 최대 굽높이가 최소 굽높이보다 크게 설정해주세요');
            }
         else if (instepMin != "" && instepMax != "" && instepMax !=0) {
...
<script>
   ...
   // 선택된 colorBox의 css 처리를 위한 클래스 변경
